...
1. A partire dal 17 gennaio 1987, l'imposta di fabbricazione e la corrispondente sovrimposta di confine sui seguenti prodotti petroliferi sono diminuite:

a) da L. 83.574 a L. 82.505 per ettolitro, alla temperatura di 15° centigradi, per le benzine speciali diverse dall'acqua ragia minerale, per la benzina e per il petrolio diverso da quello lampante;

b) da L. 8.357,40 a L. 8.250,50 per ettolitro, alla temperatura di 15° centigradi, per il prodotto denominato "Jet Fuel JP/4", destinato all'Amministrazione della difesa, relativamente al quantitativo eccedente il contingente annuo di tonnellate 18.000 sulle quali e' dovuta l'imposta nella misura normale stabilita per la benzina.
...
### Dato a Roma, addi' 16 gennaio 1987
