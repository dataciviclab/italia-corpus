...
numero: 3
data: 2001-10-18
titolo: "Modifiche al titolo V della parte seconda della Costituzione."
...
L'[articolo 114 della Costituzione](https://www.normattiva.it/uri-res/N2Ls?urn:nir:stato:costituzione:1947-12-27;const#art_114) e' sostituito dal seguente:
...
L'[articolo 116 della Costituzione](https://www.normattiva.it/uri-res/N2Ls?urn:nir:stato:costituzione:1947-12-27;const#art_116) e' sostituito dal seguente:
...
L'[articolo 117 della Costituzione](https://www.normattiva.it/uri-res/N2Ls?urn:nir:stato:costituzione:1947-12-27;const#art_117) e' sostituito dal seguente:
...
L'[articolo 118 della Costituzione](https://www.normattiva.it/uri-res/N2Ls?urn:nir:stato:costituzione:1947-12-27;const#art_118) e' sostituito dal seguente:
...
L'[articolo 119 della Costituzione](https://www.normattiva.it/uri-res/N2Ls?urn:nir:stato:costituzione:1947-12-27;const#art_119) e' sostituito dal seguente:
...
L'[articolo 120 della Costituzione](https://www.normattiva.it/uri-res/N2Ls?urn:nir:stato:costituzione:1947-12-27;const#art_120) e' sostituito dal seguente:
...
All'[articolo 123 della Costituzione](https://www.normattiva.it/uri-res/N2Ls?urn:nir:stato:costituzione:1947-12-27;const#art_123) e' aggiunto, in fine, il seguente comma:
"In ogni Regione, lo statuto disciplina il Consiglio delle autonomie locali, quale organo di consultazione fra la Regione e gli enti locali".

Nota all'art. 7:
 - Il testo dell'[art. 123 della Costituzione](https://www.normattiva.it/uri-res/N2Ls?urn:nir:stato:costituzione:1947-12-27;const#art_123), cosi' come modificato dalla presente legge, e' il seguente:
...
L'[articolo 127 della Costituzione](https://www.normattiva.it/uri-res/N2Ls?urn:nir:stato:costituzione:1947-12-27;const#art_127) e' sostituito dal seguente:
...
Al [secondo comma dell'articolo 132 della Costituzione](https://www.normattiva.it/uri-res/N2Ls?urn:nir:stato:costituzione:1947-12-27;const#art_132-com2), dopo le parole: "Si puo', con" sono inserite le seguenti: "l'approvazione della maggioranza delle popolazioni della Provincia o delle Province interessate e del Comune o dei Comuni interessati espressa mediante".

2.

L'[articolo 115](https://www.normattiva.it/uri-res/N2Ls?urn:nir:stato:costituzione:1947-12-27;const#art_115), l'[articolo 124, il primo comma](https://www.normattiva.it/uri-res/N2Ls?urn:nir:stato:costituzione:1947-12-27;const#art_124-com1) dell'[articolo 125](https://www.normattiva.it/uri-res/N2Ls?urn:nir:stato:costituzione:1947-12-27;const#art_125), l'[articolo 128](https://www.normattiva.it/uri-res/N2Ls?urn:nir:stato:costituzione:1947-12-27;const#art_128), l'[articolo 129](https://www.normattiva.it/uri-res/N2Ls?urn:nir:stato:costituzione:1947-12-27;const#art_129) e l'[articolo 130 della Costituzione](https://www.normattiva.it/uri-res/N2Ls?urn:nir:stato:costituzione:1947-12-27;const#art_130) sono abrogati.

Note all'art. 9:
 - Il testo dell'[art. 132 della Costituzione](https://www.normattiva.it/uri-res/N2Ls?urn:nir:stato:costituzione:1947-12-27;const#art_132), cosi' come modificato dalla presente legge, e' il seguente:
 ...
 - Il testo dell'[art. 125 della Costituzione](https://www.normattiva.it/uri-res/N2Ls?urn:nir:stato:costituzione:1947-12-27;const#art_125) cosi' come modificato dalla presente legge, e' il seguente:
...
Quando un progetto di legge riguardante le materie di cui al [terzo comma dell'articolo 117](https://www.normattiva.it/uri-res/N2Ls?urn:nir:stato:costituzione:1947-12-27;const#art_117-com3) e all'[articolo 119 della Costituzione](https://www.normattiva.it/uri-res/N2Ls?urn:nir:stato:costituzione:1947-12-27;const#art_119) contenga disposizioni sulle quali la Commissione parlamentare per le questioni regionali, integrata ai sensi del comma 1, abbia espresso parere contrario o parere favorevole condizionato all'introduzione di modificazioni specificamente formulate, e la Commissione che ha svolto l'esame in sede referente non vi si sia adeguata, sulle corrispondenti parti del progetto di legge l'Assemblea delibera a maggioranza assoluta dei suoi componenti. 
...
Note all'art. 11:
 - Per il testo del [terzo comma dell'art. 117 della Costituzione](https://www.normattiva.it/uri-res/N2Ls?urn:nir:stato:costituzione:1947-12-27;const#art_117-com3) vedasi l'art. 3, comma 1, terzo capoverso, della presente legge.
 - Per il testo dell'[art. 119 della Costituzione](https://www.normattiva.it/uri-res/N2Ls?urn:nir:stato:costituzione:1947-12-27;const#art_119) vedasi l'art. 5 della presente legge.